const playlist = [
  ...
  {
    file: "songs/Jumbo.mp3",
    cover: "assets/NCS.png",
    title: "Jumbo",
    artist: "Alex Skrindo",
  },
  {
    file: "songs/Fingertips.mp3",
    cover: "assets/NCS.png",
    title: "Fingertips",
    artist: "Kisma",
  },
  {
    file: "songs/Adventure.mp3",
    cover: "assets/NCS.png",
    title: "Adventure",
    artist: "JJD",
  },
  {
    file: "songs/Cetus.mp3",
    cover: "assets/NCS.png",
    title: "Cetus",
    artist: "Lensko",
  },
  {
    file: "songs/Firefly.mp3",
    cover: "assets/NCS.png",
    title: "Firefly",
    artist: "Jim Yosef",
  },
  {
    file: "songs/Which Direction.mp3",
    cover: "assets/NCS.png",
    title: "Which Direction?",
    artist: "Anikdote",
  },
  {
    file: "songs/LostP2.mp3",
    cover: "assets/NCS.png",
    title: "Lost pt. 2",
    artist: "Lost Sky, Shiah Maisel",
  },
  {
    file: "songs/You.mp3",
    cover: "assets/NCS.png",
  ...
  {
    file: "songs/Enslaved.mp3",
    cover: "assets/NCS.png",
    title: "Enslaved",
    artist: "Barren Gates, M.I.M.E",
  },
  {
    file: "songs/Popsicle.mp3",
    cover: "assets/NCS.png",
    title: "Popsicle",
    artist: "LFZ",
  },
  {
    file: "songs/Weakness.mp3",
    cover: "assets/NCS.png",
    title: "Weakness",
    artist: "Prismo",
  },
  {
    file: "songs/Puzzle.mp3",
    cover: "assets/NCS.png",
    title: "Puzzle",
    artist: "RetroVision",
  },
  {
    file: "songs/Candyland.mp3",
    cover: "assets/NCS.png",
    title: "Candyland",
    artist: "Tobu",
  },
  {
    file: "songs/Close.mp3",
    cover: "assets/NCS.png",
    title: "Close",
    artist: "IZECOLD, Molly Ann, Brooks",
  },
  {
    file: "songs/Cloud 9.mp3",
    cover: "assets/NCS.png",
    title: "Cloud 9",
    artist: "Tobu & Itro",
  },
  {
    file: "songs/Bones.mp3",
    cover: "assets/NCS.png",
    title: "Bones",
    artist: "Clarx",
  },
  {
    file: "songs/H.A.Y.mp3",
    cover: "assets/NCS.png",
    title: "H.A.Y",
    artist: "Clarx",
  },
  {
    file: "songs/Shootin Stars.mp3",
    cover: "assets/NCS.png",
    title: "Shootin Stars",
    artist: "DDark",
  },
  {
    file: "songs/Black Sunrise.mp3",
    cover: "assets/NCS.png",
    title: "Black Sunrise",
    artist: "Denniz Jamm, Andreas Stone",
  },
  {
    file: "songs/Oblivion.mp3",
    cover: "assets/NCS.png",
    title: "Oblivion",
    artist: "Dirty Palm, Micah Martin",
  },
  {
    file: "songs/Entropy.mp3",
    cover: "assets/NCS.png",
    title: "Entropy",
    artist: "Distrion, Alex Skrindo",
  },
  {
    file: "songs/Echoes.mp3",
    cover: "assets/NCS.png",
    title: "Echoes",
    artist: "Dosmatic, Anna Yvette",
  },
  {
    file: "songs/Limitless.mp3",
    cover: "assets/NCS.png",
    title: "Limitless",
    artist: "Elektronomia",
  },
  {
    file: "songs/Shivers.mp3",
    cover: "assets/NCS.png",
    title: "Shivers",
...
const translations = {
  en: {
    ...
    welcome: "Welcome",
    copyright: "All audio tracks provided by",
  ...
  pt: {
    ...
    evening: "Boa Noite",
    welcome: "Bem-vindo",
    copyright: "Todas as faixas de áudio fornecidas por",
  ...
  es: {
    ...
    welcome: "Bienvenido",
    copyright: "Todas las pistas de audio proporcionadas por",
...
function updateLanguageTexts() {
  const copyrightTextElement = document.querySelector(".copyright-text");
  if (copyrightTextElement) {
    copyrightTextElement.innerText = translations[currentLang].copyright;
  }
  if (searchInput) {
...
function typeGreeting() {
  ...
  if (iconElement) iconElement.innerText = " " + timeIcon;
  ...
  function typeWriter() {
    if (i < greetingText.length) {
      textElement.innerText += greetingText.charAt(i);
      i++;
...
searchInput.addEventListener("input", function () {
  ...
  if (filteredSongs.length > 0) {
    ...
    filteredSongs.forEach(function (song) {
      ...
      downloadBtn.title = "Baixar esta música";
      downloadBtn.setAttribute("aria-label", "Baixar " + song.title);

      downloadBtn.addEventListener("click", function (e) {
        e.stopPropagation();
        downloadSong(song.file, song.title, song.artist);
      });
